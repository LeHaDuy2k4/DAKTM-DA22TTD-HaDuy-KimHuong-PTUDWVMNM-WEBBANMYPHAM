...
if (isset($_POST['btn_cancel'])) {
    ...
    if ($conn->query($sql_cancel)) {
        if ($conn->affected_rows > 0) {
            ...
            $message = "<div class='alert alert-danger'>Không thể hủy đơn hàng này (Có thể Admin đã duyệt đơn).</div>";
        }
    }
}
...
<style>
    :root { 
        --primary-pink: #E91E63; 
        --bg-light: #fcfcfc;
        --accent-orange: #FF9800; /* Màu cho nút đánh giá */
    }
    ...
    .action-group { display: flex; gap: 12px; margin-top: 20px; justify-content: flex-end; }
    .btn-action { padding: 10px 22px; border-radius: 30px; font-weight: 700; font-size: 0.85rem; cursor: pointer; transition: 0.3s; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; }

    .btn-detail { background: var(--primary-pink); color: #fff; border: none; }
    .btn-detail:hover { background: #c2185b; box-shadow: 0 4px 12px rgba(233, 30, 99, 0.2); }

    /* Nút Đánh giá */
    .btn-review { background: var(--accent-orange); color: #fff; border: none; }
...
<div class="order-history-container">
    ...
    <?php if ($result_orders && $result_orders->num_rows > 0): ?>
        <?php while($order = $result_orders->fetch_assoc()): 
            ...
            elseif (strpos($st, 'hoàn') !== false) $statusClass = 'status-completed';
            ...
            <div class="order-card">
                ...
                <div class="order-grid">
                    <div class="delivery-info">
                        ...
                        <p><i class="fa-solid fa-phone-volume"></i> Hotline nhận hàng: <span><?php echo htmlspecialchars($order['sdtNguoiNhan']); ?></span></p>
                    </div>
                    ...
                    <div style="text-align: right;">
                        ...
                        <div class="action-group">
                            ...
                            <?php if (strpos($st, 'hoàn thành') !== false): ?>
