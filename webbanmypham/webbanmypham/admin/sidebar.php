...
/* Đẩy nội dung chính sang phải để tránh sidebar */
.main-content {
...
<div class="sidebar">
    <div class="sidebar-brand">
        <i class="fa-solid fa-spa"></i> MyPham<span>Admin</span>
    </div>
    ...
    <div class="sidebar-menu">
        <ul>
            ...
            <li>
                <a href="users.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'users.php' || basename($_SERVER['PHP_SELF']) == 'user_add.php') ? 'active' : ''; ?>">
